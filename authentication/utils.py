    ...
    <html>
        <body>
            ...
            <div style="margin-top: 30px;">
                ...
                <a href="www.vud.active.ro/login" style="padding: 10px; width: 300px; background-color: #17616C; color: white;">Accesează cont</a>
                <p>sau să copiați linkul de acces de mai jos și să-l accesați din bara de adrese: https://www.vud.active.ro/login</p>
                <p>Echipa,</p>
                <p style="color: #17616C;">Vreaudoctor.ro</p>
            </div>
        </body>
    ...
    <html>
        <body>
            ...
            <div style="margin-top: 30px;">
                ...
                <a href="https://www.vud.active.ro/register" style="padding: 10px; width: 300px; background-color: #17616C; color: white;">Creează cont</a>
                <p>Echipa,</p>
                <p style="color: #17616C;">Vreaudoctor.ro</p>
            </div>
        </body>
